...
def gen_subscription(
    ...
    (kve, kse, kfe, kva, ksa, kfa) = derive_keys(some_secrets);
    ...
    frame = struct.pack("<IQQI", device_id, start, end, channel)

    array = bytearray(frame)

    iv = kse[0:16]

    array = encrypt_cbc_aes256(array, kse, iv)

    hmac = hmac_sha256(array, ksa)
